    ...
    <div className="bg-[#07152B] text-[#C8D9E6] font-dm h-screen">
      ...
      <div className=" flex justify-evenly items-center gap">
        <div className="w-[40vw] border-2 border-border rounded-2xl drop-shadow-shadow shadow-2xl">
          <img className="w-full" src={signup} alt="Signup Illustration" />
        </div>
        <div>
          <div className="flex flex-col justify-center items-center my-4">
            <h1 className="font-cormorant text-4xl font-semibold">Create Account</h1>
          ...
          <div className=" border border-border rounded-lg p-5 w-[25vw]">
            ...
            <div className=" border-b border-border w-full py-2">
              <div>
                ...
                <div className=" py-1 flex justify-between items-center">
                  ...
                  />
                  <img className="size-6" src={profile} />
                </div>
              </div>
            </div>
            ...
            <div className="flex justify-between mt-4">
              <div className="flex justify-center items-center gap-1.5">
                <input type="checkbox" className="accent-border h-4 w-4 rounded border-2 border-slate-300 bg-slate-50 cursor-pointer" />
                <span>Remember me</span>
              </div>
              <Link className="text-sm text-accent underline" to="#">Forgot Password?</Link>
            </div>
            <div className="">
              <Link className="flex justify-center bg-button rounded-full mx-[10%] px-2 py-2 my-4" to="/">Sign in</Link>
          ...
          <span className="flex gap-1 justify-center text-sm my-3">
            Already have an account? <Link className="text-accent underline" to="/login">Sign in</Link>
          </span>
        </div>
      </div>
    </div>
